 ...
 * 참고 : 객체지향 언어인 java, c++ 에서 언급하는 객체와는 다른 개념으로 JS에서 사용된다
 *
 * JS 에서 객체
 * 조각으로 구성된 변수들을 연관된 연결고리로 한 묶음으로 묶어둔 것
 */

// 성적 : 객체(변수, object, 묶음)
// 학번, 국어, 수학, 영어 : 요소변수. 속성(Property)
// 학번, 국어, 수학, 영어 를 속성으로 갖는 성적 개체 선언
const 성적 = {
  학번: "001",
  국어: 95,
  수학: 95,
...
// 이름, 주소, 전화, 나이 를 속성으로 갖는 홍길동 객체 선언
const 홍길동 = {
  이름: "홍길동",
  주소: "서울특별시",
  전화: "010-111-1111",
...
// 이름, 주소, 전화, 나이 를 속성으로 갖는 이몽룡 객체 선언
const 이몽룡 = {
  이름: "이몽룡",
  주소: "익산시",
  전화: "010-222-2222",
