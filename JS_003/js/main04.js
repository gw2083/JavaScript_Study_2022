/**
 * 배열(Array)
 * 한 개의 변수에 다수의 데이터를 보관(저장)하기 위한 설정
 * querySelectAll() 을 사용하여 tag 들이나 class 로 설정된 항목을 가져오면
 * 자동으로 배열이 만들어지고 각각의 요소에 값들이 보관된다
 */

// 숫자 6개를 보관하는 배열을 만들고 각각의 요소에 0,1,2,3,4,5 의 값을 저장한다
...
// 0번 요소에 "우리나라만세" 라는 문자열 저장(할당, 대입)
strs[0] = "우리나라만세";
document.write("<br/>");
// strs 배열은 const 로 선언되어있기 때문에 배열에 어떤 값을 직접 대입, 저장할 수 없다
// strs = "우리나라만세";
